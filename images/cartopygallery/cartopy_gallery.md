...
```
    ...
    <ipython-input-19-925c419a9f62> in <module>()
         58 
         59 if __name__ == '__main__':
    ---> 60     main()
    

    <ipython-input-19-925c419a9f62> in main()
         52     ax.coastlines()
         53     ax.set_global()
    ---> 54     img, crs, extent, origin = geos_image()
         55     plt.imshow(img, transform=crs, extent=extent, origin=origin, cmap='gray')
         56     plt.show()


    <ipython-input-19-925c419a9f62> in geos_image()
         41     url = ('https://gist.github.com/pelson/5871263/raw/'
         42            'EIDA50_201211061300_clip2.png')
    ---> 43     img_handle = BytesIO(urlopen(url).read())
         44     img = plt.imread(img_handle)
         45     img_proj = ccrs.Geostationary(satellite_height=35786000)
